          ...
          <div className="card shadow-lg h-100">
            ...
            <div className="card-body">
                  ...
                  {selectedCard && (
                    <div className="border rounded p-4" style={{ background: 'linear-gradient(135deg, #dc3545 0%, #c82333 100%)', color: 'white' }}>
                      <div className="mb-3">
                        ...
                        <h5 className="mb-0 letter-spacing">{selectedCard.number}</h5>
                      </div>
                      <div className="row">
                        <div className="col-6">
                          <small className="opacity-75">Expiry Date</small>
                          <p className="mb-0 fw-bold">{selectedCard.period}</p>
                        </div>
                        <div className="col-6">
              ...
              <div className="border rounded p-4" style={{ background: 'linear-gradient(135deg, #dc3545 0%, #c82333 100%)', color: 'white' }}>
                <div className="mb-3">
                  <small className="opacity-75">Card Number</small>
                  <h5 className="mb-0 letter-spacing">{card?.number}</h5>
                </div>
                <div className="row">
                  <div className="col-6">
                    <small className="opacity-75">Expiry Date</small>
                    <p className="mb-0 fw-bold">{card?.period}</p>
                  </div>
                  <div className="col-6">
                    <small className="opacity-75">CVV</small>
                    <p className="mb-0 fw-bold">{card?.cvv}</p>
                  </div>
                </div>
                <div className="mt-4 pt-3 border-top border-light">
                  <div className="d-flex justify-content-between align-items-center">
